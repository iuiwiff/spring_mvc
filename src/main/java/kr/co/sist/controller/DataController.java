...
@SessionAttributes("id") //request와 session 둘 다 값이 들어간다.
@Controller
public class DataController {
	...
	public String useModel(Model model) {
		...
		model.addAttribute("id",  ts.searchId()); //requestScope.id, sessionScope.id
	...
	public ModelAndView useModelAndView() {
		...
		mav.addObject("id",  ts.searchId()); //requestScope.id, sessionScope.id
